...
import heroImage from "../assets/hero image.jpg"; // 👈 apni hero image yahan use karo
...
<section className="bg-[#f6f8f1] py-14">
  <div className="max-w-7xl mx-auto px-4">
    ...
    >
      {[
        { img: peri, name: "Peri Peri Makhana", desc: "Spicy & Crunchy Delight" },
        { img: pudina, name: "Onion & Pudina Makhana", desc: "Tangy & Refreshing Taste" },
        { img: onion, name: "Salt & Pepper Makhana", desc: "Classic Crunchy Snack" },
      ].map((item, i) => (
        <SwiperSlide key={i}>
          <div className="group bg-[#0c1a12] rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
            ...
            <div className="p-5 text-center">
              ...
              <p className="text-sm text-[#b7d789] mt-1">
                {item.desc}
              </p>

              <button className="mt-4 px-5 py-2 bg-[#85aa52] hover:bg-[#6f9141] text-white rounded-full transition shadow-md hover:scale-105">
                View Product
              </button>
            </div>
          </div>
